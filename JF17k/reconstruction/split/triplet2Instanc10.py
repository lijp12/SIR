...
f_hit_test = codecs.open('../splitResult/multiRelationMainEntity10.0.txt', 'r', 'utf-8')
...
f_candidate_clique = codecs.open('../candidateClique/candidateClique10.txt', 'w', 'utf-8')
count = 0
ind = 0
