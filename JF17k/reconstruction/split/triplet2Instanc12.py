...
f_hit_test = codecs.open('../splitResult/multiRelationMainEntityOther.txt', 'r', 'utf-8')
...
f_candidate_clique = codecs.open('../candidateClique/candidateCliqueOther.txt', 'w', 'utf-8')
count = 0
ind = 0
